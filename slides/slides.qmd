...
## Exemples biais  
Aricle Paul Le Derff

  - « Enquêter à partir et sur des données de presse. Quand la source d’information est aussi le terrain d’enquête », en cours d'évaluation (Genèses)
    - Les biais de sélection médiatique
    - Les biais d’accessibilité aux ressources presse
    - Les biais liés à la collecte de données (mots clés)
    - Erreurs techniques et variabilité éditoriale (crédits auteurs, images, etc.)
